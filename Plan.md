...
1. Expand the game model to multiplayer-ready sessions with humans and bots.
2. Add richer unit catalog (land/air/water classes) with economic costs and upkeep.
3. Implement strategic systems: groups, map templates, resource extraction, and A* pathfinding.
